...
@Composable
fun DrinksScreenContent(navController: NavController) {
    HeartBackground {
        Column(
            modifier = Modifier
                .fillMaxSize()
            ...
            val items = List(10) { i -> "Напиток ${i + 1}" }
            val images = listOf(
                R.drawable.napitok1,
                R.drawable.napitok2,
                R.drawable.napitok3,
            ...
            val customNames = listOf("Лимонный бриз", "Апельсин", "Латте", "Кровавая луна")
            val prices = listOf("$5", "$5", "$6", "$8")

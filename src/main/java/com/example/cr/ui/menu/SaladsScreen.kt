...
@Composable
fun SaladsScreenContent(navController: NavController) {
    HeartBackground {
        Column(
            modifier = Modifier
                .fillMaxSize()
            ...
            val customNames = listOf("Микс", "Свежесть", "Гармония", "Взрыв", "Салат 5", "Салат 6", "Салат 7", "Салат 8")
            val prices = listOf("$13", "$18", "$20", "$25", "$15", "$16", "$18", "$25")

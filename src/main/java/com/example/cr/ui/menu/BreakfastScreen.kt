...
@Composable
fun BreakfastScreenContent(navController: NavController) {
    val viewModel: BreakfastViewModel = viewModel()
    val breakfastItems = viewModel.breakfasts.collectAsState()
    HeartBackground {
        if (breakfastItems.value.isEmpty()) {
            ...
            Column(
                ...
                val customNames = listOf("Утро", "Мечта", "Симфония", "Рассвет", "Завтрак 5", "Завтрак 6", "Завтрак 7", "Завтрак 8")
                val prices = listOf("$10", "$12", "$15", "$13", "$15", "$16", "$18", "$25")
